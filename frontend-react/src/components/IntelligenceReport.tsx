          ...
          {cols.map(row => (
            <tr key={row}>
              ...
              {cols.map(col => {
                ...
                const bgColor = val > 0 
                  ? `rgba(2, 132, 199, ${absVal * 0.25})` 
                  : `rgba(239, 68, 68, ${absVal * 0.25})`;
                return (
            ...
            <div className="report-chart-container" style={{ width: '100%', height: 260 }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={featureWeights} layout="vertical" margin={{ top: 10, right: 30, left: 20, bottom: 10 }}>
                  ...
                  <Bar dataKey="weight" fill="#0284c7" radius={[0, 4, 4, 0]} barSize={14} isAnimationActive={false} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="report-chart-container" style={{ width: '100%', height: 180 }}>
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                  ...
                  <Area type="monotone" dataKey="confidence" stroke="#0284c7" strokeWidth={2} fill="url(#reportColorConfidence)" isAnimationActive={false} />
                </AreaChart>
              </ResponsiveContainer>
            </div>
