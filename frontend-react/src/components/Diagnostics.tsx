  ...
  return (
    <div className="diagnostics-view animate-fade-in">
      ...
      <div className="diagnostics-grid">
        ...
        {/* Left Side: Pipeline Blueprint & Orchestration stepper */}
        ...
        {/* Right Side: Infrastructure Telemetry Cards */}
        <div className="diagnostics-sidebar-grid">
          ...
          <div className="telemetry-card card">
            <div className="card-header">
              ...
              <h4>CPU Core Compute Cluster</h4>
            </div>
            <div className="telemetry-body">
              ...
              <span className="small-label">Allocated Nodes: 8x vCPUs (Intel Xeon)</span>
            </div>
          </div>
          ...
          <div className="telemetry-card card">
            ...
            <div className="telemetry-body">
              <div className="value-row">
                ...
                <span className="unit-label">of 16.0 GB</span>
              </div>
              <div className="meter-bar">
                <div className="meter-fill" style={{ width: `${(memUsage / 16) * 100}%`, backgroundColor: 'var(--accent-color)' }}></div>
              </div>
              <span className="small-label">Shared cache pool: 1.2 GB idle</span>
            </div>
          </div>
          ...
          <div className="telemetry-card card">
            ...
            <div className="telemetry-body">
              ...
              <span className="small-label">File pipeline status: STABLE</span>
            </div>
          </div>
          ...
          <div className="telemetry-card card">
            ...
            <div className="telemetry-body">
              ...
              <span className="small-label">Port bind: http://localhost:8000</span>
            </div>
          </div>
